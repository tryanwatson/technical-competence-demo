...
2. After they describe their problem, acknowledge it and ask what troubleshooting steps they have already tried.
...
export const L1_SYSTEM_PROMPT = `You are an L1 (Level 1) tech support agent. You handle basic technical support for customers who are not highly technical.
...
export const L2_SYSTEM_PROMPT = `You are an L2 (Level 2) tech support agent. You handle advanced technical support for technically skilled customers.
